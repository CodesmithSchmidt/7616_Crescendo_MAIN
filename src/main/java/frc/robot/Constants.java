...
/*
 * *****************FIXED*****************************
             What are the physical stats of the robot?
             Wheel base (front/back and width)
             Length:24.5
             Width:24.5
 */
    ...
    /*
     * ******************FIXED*********************************
     *   Use the offset calculators (black wheel frame things), and then check the
     *   driver station when the robot is on to see what the encoders are reading
     *   when all of the wheels are facing "forward"
     * 
     *    There is a setting in sparkMAX software to do this
     */
...
/*
 * *****************FIXED*****************************
      What are the CAN IDs for the different motor controllers for the drive modules)?
...
/*
 * *****************FIXED *****************************
 *    Update this constant with the build state of the robot.  What gears did we use on the swerve modules?
 * 13
 */
  ...
  public static final class RobotConstants {
    ...
    public static final int kArm1_CANID = 16;
