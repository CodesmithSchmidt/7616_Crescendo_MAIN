...
Scoring subsystem controls intake mechanism and shooting mechanism (NEO 550 with SparkMAX, and 2 Falcon500s)

Arm Subsystem controls rotating arm with Scoring subsystem mounted on it (2 NEO motors with SparkMAXes)
